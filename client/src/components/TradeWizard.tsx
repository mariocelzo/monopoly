...
const styles: Record<string, React.CSSProperties> = {
  ...
  eyebrow: { fontFamily: 'var(--font-mono)', fontSize: '0.68rem', letterSpacing: '0.1em', textTransform: 'uppercase', color: 'var(--brass)' },
  chiudi: { background: 'none', border: 'none', color: 'rgba(27,36,48,0.55)', fontSize: '1.15rem', cursor: 'pointer', minWidth: 44, minHeight: 44, padding: 0 },
  titolo: { fontSize: '1.3rem' },
  conChi: { fontSize: '0.82rem', color: 'rgba(27,36,48,0.6)', margin: 0 },
  ...
  gruppoNome: { fontSize: '0.72rem', letterSpacing: '0.08em', textTransform: 'uppercase', color: 'rgba(27,36,48,0.6)' },
  completo: { fontSize: '0.62rem', color: 'var(--brass)', border: '1px solid var(--brass)', borderRadius: 4, padding: '1px 6px', marginLeft: 'auto' },
  parziale: { fontSize: '0.66rem', color: 'rgba(27,36,48,0.45)', fontFamily: 'var(--font-mono)', marginLeft: 'auto' },
  ...
  vuoto: { fontSize: '0.82rem', color: 'rgba(27,36,48,0.45)', fontStyle: 'italic', margin: 0 },
  lato: { display: 'flex', flexDirection: 'column', gap: 6, padding: 13, borderRadius: 10, background: 'rgba(27,36,48,0.04)', border: '1px solid rgba(27,36,48,0.15)' },
  latoTitolo: { fontSize: '0.74rem', letterSpacing: '0.07em', textTransform: 'uppercase', color: 'rgba(27,36,48,0.6)' },
  ...
  riepDenaro: { fontSize: '1.05rem', color: 'var(--brass)', marginTop: 3 },
  freccia: { textAlign: 'center', fontSize: '1.3rem', color: 'var(--brass)' },
  avviso: { fontSize: '0.8rem', color: 'rgba(27,36,48,0.6)', margin: 0, fontStyle: 'italic' },
  piede: {
  ...
  puntino: { width: 7, height: 7, borderRadius: '50%', background: 'rgba(27,36,48,0.25)' },
