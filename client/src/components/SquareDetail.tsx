...
const styles: Record<string, React.CSSProperties> = {
  ...
  title: { fontSize: '1.25rem', textAlign: 'center', padding: '16px 18px 0', color: 'var(--ink)' },
  price: { fontFamily: 'var(--font-mono)', fontSize: '1.35rem', color: 'var(--brass)', textAlign: 'center', margin: '6px 0 0' },
  rents: { display: 'flex', flexDirection: 'column', gap: 3, padding: '14px 18px 0' },
  rentRow: { display: 'flex', justifyContent: 'space-between', gap: 10, fontSize: '0.78rem', borderBottom: '1px dotted rgba(27,36,48,0.15)', paddingBottom: 3 },
  rentRowActive: { background: 'rgba(201,150,44,0.12)', borderRadius: 4, padding: '2px 6px', marginLeft: -6, marginRight: -6 },
  rentLabel: { color: 'rgba(27,36,48,0.65)' },
  rentLabelActive: { color: 'var(--brass)', fontWeight: 700 },
  rentValueActive: { fontFamily: 'var(--font-mono)', color: 'var(--brass)', fontWeight: 700 },
  rentValue: { fontFamily: 'var(--font-mono)', color: 'var(--ink)' },
  note: { fontSize: '0.72rem', color: 'rgba(27,36,48,0.5)', margin: '8px 18px 0' },
  ownerRow: { display: 'flex', alignItems: 'center', gap: 8, fontSize: '0.8rem', margin: '14px 18px 0', paddingTop: 12, borderTop: '1px solid rgba(27,36,48,0.12)', color: 'var(--ink)' },
  ownerDot: { width: 11, height: 11, borderRadius: 3, flexShrink: 0 },
  free: { color: 'rgba(27,36,48,0.5)', fontStyle: 'italic' },
