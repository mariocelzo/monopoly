...
const styles: Record<string, React.CSSProperties> = {
  ...
  destLabel: { fontSize: '0.76rem', color: 'rgba(27,36,48,0.6)' },
  ...
  columnTitle: { fontSize: '0.8rem', letterSpacing: '0.06em', textTransform: 'uppercase', color: 'rgba(27,36,48,0.6)' },
  list: { display: 'flex', flexDirection: 'column', gap: 9 },
  none: { fontSize: '0.78rem', color: 'rgba(27,36,48,0.45)', fontStyle: 'italic', margin: 0 },
  ...
  pendingNote: { fontSize: '0.78rem', color: 'rgba(27,36,48,0.6)', fontStyle: 'italic', margin: 0 },
  ...
  gruppoNome: { fontSize: '0.68rem', letterSpacing: '0.07em', textTransform: 'uppercase', color: 'rgba(27,36,48,0.58)' },
  completo: { fontSize: '0.6rem', color: 'var(--brass)', border: '1px solid var(--brass)', borderRadius: 4, padding: '1px 5px', marginLeft: 'auto' },
  parziale: { fontSize: '0.64rem', color: 'rgba(27,36,48,0.42)', fontFamily: 'var(--font-mono)', marginLeft: 'auto' },
  // Il patto, aggiornato mentre si sceglie: fuori dallo scorrimento come i bottoni.
  patto: { borderTop: '1px solid rgba(27,36,48,0.12)', paddingTop: 11, display: 'flex', flexDirection: 'column', gap: 6, flexShrink: 0 },
  pattoLabel: { fontFamily: 'var(--font-mono)', fontSize: '0.64rem', letterSpacing: '0.1em', textTransform: 'uppercase', color: 'var(--brass)' },
  pattoRiga: { display: 'flex', alignItems: 'center', gap: 12 },
  pattoLato: { flex: 1, fontSize: '0.85rem', padding: '8px 11px', borderRadius: 8, background: 'rgba(27,36,48,0.04)' },
  pattoFreccia: { fontSize: '1.1rem', color: 'var(--brass)' },
  actions: { display: 'flex', gap: 10, borderTop: '1px solid rgba(27,36,48,0.12)', paddingTop: 14, flexShrink: 0 },
};
