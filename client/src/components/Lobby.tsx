...
const styles: Record<string, React.CSSProperties> = {
  ...
  inviteCode: { color: 'var(--brass)', letterSpacing: '0.12em' },
  label: { fontSize: '0.8rem', color: 'rgba(27,36,48,0.6)', marginTop: 14, marginBottom: 6 },
  input: { padding: '11px 14px', borderRadius: 8, border: '1px solid rgba(27,36,48,0.2)', background: 'rgba(27,36,48,0.06)', color: 'var(--ink)', fontSize: '1rem' },
  ...
  error: { color: 'var(--danger)', fontSize: '0.85rem', marginTop: 10 },
};
