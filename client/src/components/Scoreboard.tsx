...
const styles: Record<string, React.CSSProperties> = {
  ...
  title: { fontFamily: 'var(--font-mono)', fontSize: '0.7rem', letterSpacing: '0.08em', textTransform: 'uppercase', color: 'var(--brass)' },
  ...
  tally: { color: 'rgba(27,36,48,0.6)', fontSize: '0.76rem', whiteSpace: 'nowrap' },
  records: { display: 'flex', flexDirection: 'column', gap: 3, marginTop: 2 },
  recordLine: { fontSize: '0.74rem', color: 'rgba(27,36,48,0.6)' },
  note: { fontSize: '0.7rem', color: 'rgba(27,36,48,0.45)', fontStyle: 'italic', marginTop: 4, lineHeight: 1.4 },
  resetLink: {
    alignSelf: 'flex-start',
    background: 'none',
    border: 'none',
    color: 'rgba(27,36,48,0.4)',
    fontSize: '0.72rem',
  ...
  confirmText: { fontSize: '0.74rem', color: 'var(--ink)' },
